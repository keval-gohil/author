        ...
        <div className="more-info">
            ...
            <div className="info-row">
                ...
                <div className="more-github">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="6" r="4"/><path stroke-linecap="round" d="M19.998 18q.002-.246.002-.5c0-2.485-3.582-4.5-8-4.5s-8 2.015-8 4.5S4 22 12 22c2.231 0 3.84-.157 5-.437"/></g></svg>
                    </div>
                    
                    <p>Get something good from me — hire me through <a href="https://github.com/keval-gohil">linkedIn</a> or <a href="mailto:kg256853@gmail.com">email</a></p>
                </div>
            </div>
        </div>
    </>
