    ...
    <>
      <div className='project-list'>
        ...
        <div className='proj-row'>
          ...
          <div className='proj-column'>
            <div className="proj-text">
              <a href="https://ktalk.vercel.app/" target='_blank' className='proj2'><img src="./proj2.png" alt="proj2" /></a>
              <b>Anonymous Aether</b>
              <p>Next.js 15, Typescript, Firebase -(BaaS), Websocket, Redux</p>
            </div>
          </div>

          <div className='proj-column'>
            <div className="proj-text">
              <a href="https://keap.vercel.app/" target='_blank' className='proj3'><img src="./proj3.png" alt="proj3" /></a>
              {/* <b>Eco-K Ecommerce</b>
              <p>Next.js 14, Typescript, Boundless-Commerce, Stripe, Webhook</p> */}
              <b>KEAP edits</b>
              <p>Next.js 14, Typescript, Axios, Firebase, Redux, GSAP, DropBox</p>
            </div>
          </div>
